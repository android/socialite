...
@Composable
internal fun tryIntoClipData(mediaItem: TimelineMediaItem): ClipData? {
    val context = LocalContext.current
    return remember(mediaItem, context) {
        context.tryCreateClipData(mediaItem.uri.toUri()).getOrNull()
    }
}
